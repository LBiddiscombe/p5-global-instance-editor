...
const stdFuncs = {
	Math: ['abs', 'ceil', 'exp', 'floor', 'log', 'max', 'min', 'pow', 'round', 'sqrt']
};

const p5funcs = [...p5callFuncs, ...p5slowFuncs];

const p5exprs = [...p5callFuncs, ...p5vars, ...p5slowFuncs];

export { p5scopeFuncs, p5callFuncs, p5funcs, p5exprs, p5vars, p5Instance, stdFuncs, p5slowFuncs };
